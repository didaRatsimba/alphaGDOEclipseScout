package mg.alpha.gestion.operations.server;
 ...
 * org.eclipse.equinox.http.jetty.context.path=/GestionOperations_server
 ...
 * eclipse.product=mg.alpha.gestion.operations.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    LOG.info("GestionOperations server initialized");
    return EXIT_OK;
  }
